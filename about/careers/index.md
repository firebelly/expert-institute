    ...
    <div class="site-wrapper">
        ...
        <div class="section-content">
            ...
            <ul class="two-column animate-in">
                <li><span>Premium medical dental vision</span></li>
                <li><span>Competitive 401K</span></li>
                <li><span>Supplemental Life Insurance</span></li>
                <li><span>Short Term Disability</span></li>
                <li><span>Basic Life AD&D</span></li>
                <li><span>Gym Memberships</span></li>
                <li><span>Flexible Spending Accounts/Dependent Care</span></li>
                <li><span>Meetups and Learning Opportunities</span></li>
                <li><span>Offsite Activities and Happy Hours</span></li>
                <li><span>Personal Time Off</span></li>
                <li><span>Active Office Culture</span></li>
                <li><span>Commuter Benefits</span></li>
                <li><span>Company Dinners</span></li>
                <li><span>Office Dog</span></li>
                <li><span>Meals and Snacks</span></li>
            </ul>
        </div>
    </div>
</div>
