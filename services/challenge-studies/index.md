...
<div class="showcase-section with-image -top section parallax-image-container -mint">
...
<div class="showcase-section with-image -bottom section parallax-image-container -teal">
    <div class="section-background"></div>
    <div class="-inner grid">
        <div class="section-content">        
...
<div id="challenge-study-sample" class="challenge-study-sample-section section colored-swoop -gray-light">
  <div class="-inner site-wrapper grid">
    <h2 class="sub-title">Challenge Study</h2>
    <div class="text -left">
      <h1 class="section-title">Sample<br> Challenge<br> Study</h1>
      <p>Download a free example of our Expert Witness Challenge Study by filling out the form. Scroll down to discover more.</p>
    </div>
