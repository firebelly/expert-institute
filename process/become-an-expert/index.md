...
<div class="section centered-text-section">
    <div class="site-wrapper">
        <h5 class="section-label">Join Our Expert Network</h5>
        <div class="section-content">
...
<div class="showcase-section -top section parallax-image-container -gray-light">
    <div class="section-background parallax-image" style="background-image:url('/dist/images/become-an-expert-showcase-1.jpg');"></div>
    <div class="-inner grid">
        <div class="section-content">        
            <h1 class="section-title animate-in">Join For Free</h1>
            <p class="animate-in">Once your application is accepted, you will be connected with top litigators searching for expert witnesses at no cost.</p>
        </div>
    </div>
</div>

<div class="showcase-section -middle section parallax-image-container -gray-light">
    <div class="section-background parallax-image" style="background-image:url('/dist/images/become-an-expert-showcase-2.jpg');"></div>
    <div class="-inner grid">
        <div class="section-content">
            ...
            <h1 class="section-title animate-in">Keep 100%<br> of your fees</h1>
            <p class="animate-in">Keep all of your fees and handle your own billing. You work directly with the attorney on every engagement.</p>
        </div>
    </div>
</div>

<div class="showcase-section -bottom section parallax-image-container -gray-light">
    <div class="section-background parallax-image" style="background-image:url('/dist/images/become-an-expert-showcase-3.jpg');"></div>
    <div class="-inner grid">
        <div class="section-content">        
            <h1 class="section-title animate-in">Leverage Our Network</h1>
            <p class="animate-in">Expand the reach of your consulting practice. Members enjoy unparalleled access to the world’s leading legal professionals.</p>
        </div>
    </div>
</div>

{% include testimonials-section.html section-classes="padded-top-lg" no-autoplay="true" %}
